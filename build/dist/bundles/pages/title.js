...
var ShowTitle_ShowTitleList = function (_React$Component) {
  ...
  function ShowTitleList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ShowTitleList.__proto__ || Object.getPrototypeOf(ShowTitleList)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (id) {
      router__default.a.push({ pathname: '/post', query: { id: id } });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(ShowTitleList, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement(
        'div',
        { className: classes.root },
        data.archives ? external__react__default.a.createElement(
          'div',
          null,
          external__react__default.a.createElement(
            List__default.a,
            { dense: true, className: classes.root, subheader: external__react__default.a.createElement(
                ListSubheader__default.a,
                { className: classes.subHeader },
                data.tagname
              ) },
            data.archives.map(function (archive, i) {
              return external__react__default.a.createElement(
                'div',
                { key: 'archives' + i, className: classes.listSection },
                external__react__default.a.createElement(external__material_ui_["Divider"], { className: classes.divider }),
                external__react__default.a.createElement(
                  ListSubheader__default.a,
                  null,
                  archive.yearMonth
                ),
                archive.titles && archive.titles.map(function (title, j) {
                  return external__react__default.a.createElement(
                    List_["ListItem"],
                    { button: true, key: 'archives' + i + 'title' + j,
                      onClick: _this2.handleClick.bind(_this2, title._id)
                    },
                    external__react__default.a.createElement(List_["ListItemText"], { primary: title.title })
                  );
                })
              );
            })
...
var title_Title = function Title(props) {
  ...
  return external__react__default.a.createElement(
    ...
    external__react__default.a.createElement(ShowTitle, { data: props.data })
  );
};

title_Title.getInitialProps = function () {
