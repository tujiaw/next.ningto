...
var RightSideBar = function RightSideBar(props) {
    ...
    return _react2.default.createElement(_materialUi.Grid, { item: true, xs: 4, className: classes.root }, profile && _react2.default.createElement(_ProfileCard2.default, { profile: profile }), _react2.default.createElement('br', null), !_utils2.default.isEmptyObject(hotData) && _react2.default.createElement(_Group2.default, { data: hotData }), _react2.default.createElement('br', null), !_utils2.default.isEmptyObject(tagData) && _react2.default.createElement(_Group2.default, { data: tagData }), _react2.default.createElement('br', null), !_utils2.default.isEmptyObject(archiveData) && _react2.default.createElement(_Group2.default, { data: archiveData }));
};
